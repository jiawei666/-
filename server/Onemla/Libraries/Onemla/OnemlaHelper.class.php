...
class OnemlaHelper{
    ...
    const ACTIVED_ADMIN         = 10;//用户管理
    const ACTIVED_ADMIN_ONE     = 101;//用户管理
    const ACTIVED_ADMIN_TWO     = 102;//认证信息
    const ACTIVED_ADMIN_THREE     = 103;//密码设置
    
    const ACTIVED_ACTIVITY         = 11;//活动管理
    const ACTIVED_ACTIVITY_ONE = 111;
    
    const ACTIVED_REPAIR       = 12;//工单管理
    const ACTIVED_REPAIR_ONE       = 121;//工单管理

    const ACTIVED_CAANDSO     = 13;//案例管理
    const ACTIVED_CAANDSO_ONE       = 131;//案例管理
    const ACTIVED_CAANDSO_TWO       = 132;//解决方案

    const ACTIVED_LIVE_ROOM     = 14;//直播管理
    const ACTIVED_LIVE_ROOM_ZERO       = 140;//直播商管理
    const ACTIVED_LIVE_ROOM_ONE       = 141;//直播管理
    const ACTIVED_LIVE_ROOM_THREE       = 143;//性质分类管理
    const ACTIVED_LIVE_ROOM_TWO       = 142;//性质分类管理
    
    const ACTIVED_MEMBER       =20;//会员管理
    const ACTIVED_MEMBER_ZERO       = 200;//会员信息
    const ACTIVED_MEMBER_ONE       = 201;//会员信息
    const ACTIVED_MEMBER_TWO       = 202;//会员信息
    const ACTIVED_MEMBER_THEWW       = 203;//会员信息
    
    const ACTIVED_MEMBER_ACTIVITY       = 21;//会员活动管理
    const ACTIVED_MEMBER_ACTIVITY_ONE       = 211;//活动列表
    
    const ACTIVED_MEMBER_REPAIR       = 22;//会员工单管理
    const ACTIVED_MEMBER_REPAIR_ONE       = 221;//工单列表

    const ACTIVED_MEMBER_LIVE_BSN       = 23;//直播商管理
    const ACTIVED_MEMBER_LIVE_BSN_ONE       = 231;//直播商
    const ACTIVED_MEMBER_LIVE_BSN_TWO       = 232;//频道
    const ACTIVED_MEMBER_LIVE_BSN_THREE       = 233;//标签
    const ACTIVED_MEMBER_LIVE_BSN_FOUR       = 234;//直播间
