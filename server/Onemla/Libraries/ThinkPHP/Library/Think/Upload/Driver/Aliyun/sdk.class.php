<?php
namespace Think\Upload\Driver\Aliyun;
/**
 * OSS(Open Storage Services) PHP SDK v1.1.6
 */
//设置默认时区
use Think\Exception;
use Think\Upload\Driver\Aliyun\util\MimeTypes;
use Think\Upload\Driver\Aliyun\lib\requestcore\RequestCore;
use Think\Upload\Driver\Aliyun\lib\requestcore\ResponseCore;
