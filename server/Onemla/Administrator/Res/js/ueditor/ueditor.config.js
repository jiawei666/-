...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["undo","redo","insertunorderedlist","insertorderedlist","insertimage","emotion","spechars","italic","underline","pasteplain"]]
...
//           ]
        ...
        // ,highlightCssUrl:URL + "third-party/SyntaxHighlighter/shCoreDefault.css?v={:SITE_VERSION}"
        ...
        //codeMirrorCssUrl css加载的路径，默认是 URL + "third-party/codemirror/codemirror.css?v={:SITE_VERSION}"
        //,codeMirrorCssUrl:URL + "third-party/codemirror/codemirror.css?v={:SITE_VERSION}"
