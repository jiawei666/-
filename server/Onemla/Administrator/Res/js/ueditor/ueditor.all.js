        ...
        if(opt.sourceEditor == "codemirror"){
            ...
            me.addListener("ready",function(){
                ...
                utils.loadFile(document,{
                    ...
                    rel : "stylesheet",
                    type : "text/css",
                    href : opt.codeMirrorCssUrl || opt.UEDITOR_HOME_URL + "third-party/codemirror/codemirror.css?v={:SITE_VERSION}"
                });
...
(function () {
    ...
    UE.ui.Editor = function (options) {
        ...
        utils.loadFile(document, {
            href:editor.options.themePath + editor.options.theme + "/css/ueditor.css?v={:SITE_VERSION}",
            tag:"link",
            type:"text/css",
            rel:"stylesheet"
        });
